<template>
    <div>
        <div id="screen0" class="h-screen w-full bg-red-500">
            <img class="w-full h-full object-cover" src="@/assets/images/bg.jpeg" alt="">
        </div>
        <div ref="screen1Ref" id="screen1" class="h-screen  m-0 p-0 w-full bg-green-700">
            <video ref="videoRef" id="video" class="w-full object-cover h-full" src="@/assets/video/firework.mp4" />
        </div>
        <div id="screen2" class="h-screen relative bg-blue-500">
            <div
                ...
                <div class="div1 z-0 w-52 h-full absolute inset-0 bg-purple-200 text-center">1</div>
                <div class="div2 z-30 w-52 h-full absolute inset-0 bg-blue-200 text-center">2</div>
                <div class="div3 z-40 w-52 h-full absolute inset-0 bg-pink-500 text-center">3</div>
                <div class="div4 z-50 w-52 h-full absolute inset-0 bg-red-200 text-center z">4</div>
                <div class="div5 z-40 w-52 h-full absolute inset-0 bg-orange-500 text-center">5</div>
                <div class="div6 z-30 w-52 h-full absolute inset-0 bg-green-200 text-center">6</div>
                <div class="div7 z-0 w-52 h-full absolute inset-0 bg-yellow-200 text-center">7</div>
            </div>
        </div>
